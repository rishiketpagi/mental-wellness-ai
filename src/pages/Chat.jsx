                        ...
                        messages.map((msg, index) => (
                            ...
                            >
                                <div className="max-w-[85%] sm:max-w-[75%]">
                                    <p className={`mb-1 px-1 text-[11px] font-semibold ${
                                        msg.sender === "user"
                                    ...
                                    <div className={`rounded-3xl px-4 py-3 text-sm leading-relaxed whitespace-pre-wrap shadow-sm ${
                                        msg.sender === "user"
                ...
                <div className="border-t border-gray-100 bg-white p-3 sm:p-4">
                    <div className="flex items-end gap-2">
                        ...
                        <button
                            ...
                            className={`flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl text-white transition-all duration-200 ${
